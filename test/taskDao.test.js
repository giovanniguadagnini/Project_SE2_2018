...
describe('createTask method taskDao test cases', async () => {
...
describe('getTask method taskDao test cases', async () => {
    test('check getTasks()', () => {
        expect.assertions(1);
        return taskDao.getTasks({ id: dummies.dummyTeacher.id }).then(tasks => {
            expect(tasks).toEqual([dummies.dummyTask1,dummies.dummyTask2,dummies.dummyTask3]);//[TODO]
        });
    });
...
describe('getTaskById method taskDao test cases', async () => {
...
describe('updateTaskById method taskDao test cases', async () => {
...
describe('deleteTaskById method taskDao test cases', async () => {
...
describe('getTasksByExam method taskDao test cases', async () => {
